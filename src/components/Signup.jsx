      ...
      <div  className='w-full max-w-md bg-white shadow-md rounded px-8 py-6'>
        ...
        onSubmit={handleSubmit}>
            ...
            <div className='mb-4'>
                ...
                placeholder='Enter Your Name' className='w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500'
                required/>
            </div>
            <div className='mb-4'>
                <label className='block text-gray-700 text-sm font-bold mb-2'
        ...
        <div className='pt-5'>
        <p>Already have an Account? <Link className='text-decoration-line: underline text-blue-600 font-bold'   to="/">SignIn</Link></p> 
        </div>
    </div>
  )
}
